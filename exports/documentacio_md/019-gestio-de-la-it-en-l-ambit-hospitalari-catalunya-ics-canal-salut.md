---
id: 19
title_ca: "Gestió de la IT en l'Àmbit Hospitalari - Catalunya (ICS / Canal Salut)"
title_es: "Gestión de la IT en el Ámbito Hospitalario - Cataluña (ICS / Canal Salud)"
type: "guia"
source: "Institut Català de la Salut (ICS) - Generalitat de Catalunya"
jurisdiction: "autonomica"
publication_year: 2024
status: "vigent"
url: "https://canalsalut.gencat.cat/ca/salut-a-z/a/avaluacions-mediques/baixa-medica/gestio-ingres-hospitalari/"
file_key: null
tags: ["IT hospitalari","ICS","Catalunya","ingrés hospitalari","CMA","cirurgia major ambulatòria","ZAS_GESTIO_IT","eCap","Canal Salut","hospitalització prolongada","part","baixa laboral hospital","RD 625/2014"]
created_at: "2026-02-11T13:08:16.000Z"
updated_at: "2026-03-28T13:28:07.000Z"
---
...
|---|---|
| Tipus | guia |
| Font | Institut Català de la Salut (ICS) - Generalitat de Catalunya |
| Àmbit | autonomica |
| Any de publicació | 2024 |
| Estat | vigent |
| Enllaç oficial | [Obrir font](https://canalsalut.gencat.cat/ca/salut-a-z/a/avaluacions-mediques/baixa-medica/gestio-ingres-hospitalari/) |
| Etiquetes | IT hospitalari, ICS, Catalunya, ingrés hospitalari, CMA, cirurgia major ambulatòria, ZAS_GESTIO_IT, eCap, Canal Salut, hospitalització prolongada, part, baixa laboral hospital, RD 625/2014 |

## Resum

Protocol de gestió de la IT en l'àmbit hospitalari a Catalunya (ICS). Des de 2023-2024, les IT per ingrés hospitalari, CMA i alta per part es gestionen des del mateix hospital via plataforma integrada (ZAS_GESTIO_IT). Cobreix: ingressos ≥7 dies (comunicat automàtic 14 dies), CMA (<5 dies: baixa+alta simultànies; ≥5 dies: seguiment al CAP), ingrés per part (alta IT dia anterior al part), coordinació hospital-eCap, hospitalitzacions prolongades (grups RD 625/2014), errors de documentació, embaràs de risc, AT/MP, i resum executiu per al metge de família.

## Contingut original del catàleg

# Gestió de la Incapacitat Temporal (IT) en l'Àmbit Hospitalari - Catalunya (ICS)
...
# Gestión de la IT en el Ámbito Hospitalario - Cataluña (ICS / Canal Salud)

### Resumen

Protocolo de gestión de la IT en el ámbito hospitalario en Cataluña (ICS). Desde 2023-2024, las IT por ingreso hospitalario, CMA y alta por parto se gestionan desde el propio hospital vía plataforma integrada (ZAS_GESTIO_IT). Cubre: ingresos ≥7 días (comunicado automático 14 días), CMA (<5 días: baja+alta simultáneas; ≥5 días: seguimiento en el CAP), ingreso por parto (alta IT día anterior al parto), coordinación hospital-eCAP, hospitalizaciones prolongadas (grupos RD 625/2014), errores de documentación, embarazo de riesgo, AT/MP, y resumen ejecutivo para el médico de familia.

### Contenido traducido disponible

# Gestión de la Incapacidad Temporal (IT) en el Ámbito Hospitalario - Cataluña (ICS)

**Fuente principal**: Canal Salut - Generalitat de Catalunya (actualizado 19/02/2025)
**Fuente complementaria**: Consorci Hospitalari de Vic (CHV), Hospital Universitari de Vic
**Ámbito**: Cataluña (red ICS y centros concertados CatSalut)
**Normativa de referencia**: RD 625/2014 (modificado por RD 1060/2022, en vigor desde 01/04/2023)

---

## 1. Principio general: la IT hospitalaria se gestiona desde el propio centro

Desde 2023-2024, las incapacidades temporales generadas por **ingreso hospitalario** o por una **cirugía mayor ambulatoria (CMA)** y el alta de una IT por motivo de **parto**, **se gestionan desde el propio hospital**, a través de una plataforma integrada en el sistema de información del centro (conectada al eCap y al sistema de la Seguridad Social).

**Objetivos del cambio:**
- Agilizar los procesos administrativos
- Disminuir el número de contactos en la atención primaria por gestiones de este tipo
- Desburocratizar el sistema
- Mejorar la experiencia del paciente y su entorno
- Evitar desplazamientos innecesarios al CAP tanto del paciente como de sus familiares

---

## 2. Tres escenarios principales

### 2.1 Ingreso hospitalario (hospitalización convencional)

**Quién gestiona la baja:** La administración del centro hospitalario recoge la información requerida para gestionar la IT, en caso de que el paciente necesite la baja por encontrarse en situación laboral activa.

**Plazos y comunicados:**

| Situación | Comunicado emitido | Validez |
|----------|---------------|---------|
| Ingreso ≥ 7 días | Comunicado de confirmación automático | Hasta 14 días |
| Ingreso < 7 días | Primer comunicado se emite al salir del hospital | Hasta 14 días |
| Seguimiento posterior | Atención primaria (médico de familia) | Según grupo de proceso (RD 625/2014) |

**Requisitos del paciente para poder tramitar la baja en el hospital:**
- Disponer de tarjeta sanitaria con Código de Identificación Personal (CIP)
- Encontrarse en edad laboral: entre 16 y 70 años
- Estar trabajando (con contrato laboral o en régimen de autónomos) o cobrando subsidio de desempleo
- Estar ingresado por vía CatSalut (no privada, no accidente laboral/deportivo/tráfico, no funcionarios con mutua)

**Casos que NO se pueden tramitar desde el hospital:**
- Pacientes ingresados por vía privada
- Accidentes laborales, deportivos o de tráfico
- Funcionarios con mutua propia

**Quién puede solicitar la baja en el hospital:**
- El propio paciente
- Un familiar del paciente
- A través de la administración de Admisiones o urgencias/planta

**Horario de tramitación (CHV como ejemplo):** lunes a viernes, de 13:00 a 19:00 h en Admisiones.

### 2.2 Cirugía Mayor Ambulatoria (CMA)

La CMA es una intervención quirúrgica en la que el paciente no pernocta en el hospital (entra y sale el mismo día).

**Funcionamiento:**
1. La administración del centro recoge la información requerida para gestionar la IT
2. Según el **diagnóstico de la intervención**, la **edad** y el **CNO (Código Nacional de Ocupación)**
