---
id: 60001
title_ca: "Reial Decret 1060/2022, de 27 de desembre (BOE-A-2023-160) - Gestió electrònica dels parts d'IT"
title_es: "Real Decreto 1060/2022, de 27 de diciembre (BOE-A-2023-160) - Gestión electrónica de los partes de IT"
type: "decreto"
source: "BOE - Ministeri d'Inclusió, Seguretat Social i Migracions"
jurisdiction: "estatal"
publication_year: 2023
status: "vigent"
url: "https://www.boe.es/buscar/act.php?id=BOE-A-2023-160"
file_key: null
tags: ["IT","parts mèdics","tramitació electrònica","RD 625/2014","gestió IT","sistema RED","INSS","RD 1060/2022"]
created_at: "2026-03-20T20:08:34.000Z"
updated_at: "2026-03-29T15:51:03.000Z"
---
...
|---|---|
| Tipus | decreto |
| Font | BOE - Ministeri d'Inclusió, Seguretat Social i Migracions |
| Àmbit | estatal |
| Any de publicació | 2023 |
| Estat | vigent |
| Enllaç oficial | [Obrir font](https://www.boe.es/buscar/act.php?id=BOE-A-2023-160) |
| Etiquetes | IT, parts mèdics, tramitació electrònica, RD 625/2014, gestió IT, sistema RED, INSS, RD 1060/2022 |

## Resum

Modifica el RD 625/2014 eliminant l'obligació de la persona treballadora de lliurar la còpia en paper dels parts mèdics a l'empresa. Estableix la tramitació electrònica: l'INSS comunica directament a l'empresa l'expedició dels parts. Les empreses han de transmetre dades a l'INSS per sistema RED en 3 dies hàbils. Fixa quatre grups de processos amb terminis de confirmació: a) <5 dies (alta simultània), b) 5-30 dies (revisió ≤7 dies, confirmació ≤14 dies), c) 31-60 dies (revisió ≤7 dies, confirmació ≤28 dies), d) ≥61 dies (revisió ≤14 dies, confirmació ≤35 dies). Entrada en vigor: 1 d'abril de 2023.

## Contingut original del catàleg

# Reial Decret 1060/2022, de 27 de desembre
...
Quan el comunicat d'alta sigui expedit per l'inspector mèdic de l'INSS o de l'ISM, aquestes entitats traslladaran les dades al servei públic de salut i a la mútua de manera immediata (primer dia hàbil).
...
## Procediment per al metge de família
...
# Real Decreto 1060/2022, de 27 de diciembre (BOE-A-2023-160) - Gestión electrónica de los partes de IT

### Resumen

Contexto: Documento normativo: Real Decreto 1060/2022, de 27 de diciembre (BOE-A-2023-160) - Gestión electrónica de los partes de IT

Modifica el RD 625/2014 eliminando la obligación de la persona trabajadora de entregar la copia en papel de los partes médicos a la empresa. Establece la tramitación electrónica: el INSS comunica directamente a la empresa la expedición de los partes. Las empresas deben transmitir datos al INSS por sistema RED en 3 días hábiles. Fija cuatro grupos de procesos con plazos de confirmación: a) <5 días (alta simultánea), b) 5-30 días (revisión ≤7 días, confirmación ≤14 días), c) 31-60 días (revisión ≤7 días, confirmación ≤28 días), d) ≥61 días (revisión ≤14 días, confirmación ≤35 días). Entrada en vigor: 1 de abril de 2023.

### Contenido traducido disponible

# Real Decreto 1060/2022, de 27 de diciembre

**BOE núm. 4, de 5 de enero de 2023 | Referencia: BOE-A-2023-160**
**Entrada en vigor: 1 de abril de 2023**

Modifica el Real Decreto 625/2014, de 18 de julio, por el que se regulan determinados aspectos de la gestión y control de los procesos por incapacidad temporal en los primeros trescientos sesenta y cinco días de su duración.

---

## Preámbulo

El Real Decreto 625/2014 adaptó la regulación vigente a una serie de reformas legales y a los avances en la coordinación entre los servicios públicos de salud, las entidades gestoras de la Seguridad Social y las mutuas colaboradoras. Flexibilizó los plazos de emisión de los partes médicos de confirmación y potenció el uso de las nuevas tecnologías para el intercambio de datos.

El objeto principal de este real decreto es **eliminar la obligación de la persona trabajadora de entregar a la empresa la copia en papel de los partes médicos**. Los actuales medios electrónicos permiten que la administración comunique directamente a la empresa la expedición de los partes médicos, y que la empresa transmita a la administración los datos adicionales necesarios para la gestión de la IT.

---

## Artículo único. Modificación del Real Decreto 625/2014

### Uno. Modificación del artículo 2.3 — Grupos de procesos y plazos de los partes de confirmación

Los partes de baja y de confirmación se extenderán en función del periodo de duración que estime el médico. Se establecen **cuatro grupos de procesos**:

| Grupo | Duración estimada | Primer parte de confirmación | Partes de confirmación sucesivos |
|------|-------------------|-----------------------------|----------------------------------|
| **a)** | Menos de 5 días naturales | El médico emite la baja y el alta en el **mismo acto médico** | No los hay (alta simultánea) |
| **b)** | 5 a 30 días naturales | Revisión en **máx. 7 días** desde la baja inicial | Cada **máx. 14 días** |
| **c)** | 31 a 60 días naturales | Revisión en **máx. 7 días** desde la baja inicial | Cada **máx. 28 días** |
| **d)** | 61 o más días naturales | Revisión en **máx. 14 días** desde la baja inicial | Cada **máx. 35 días** |

> **Nota importante (grupo a):** La persona trabajadora puede solicitar un reconocimiento médico el día fijado como fecha de alta. Si el facultativo considera que no ha recuperado la capacidad laboral, puede emitir el parte de confirmación de la baja.

> **Cláusula de flexibilidad:** En cualquiera de los procesos, el facultativo puede fijar la revisión médica en un periodo **inferior** al indicado para cada grupo.

### Dos. Modificación del artículo 6.3 — Propuesta de alta de la mutua

Cuando la propuesta de alta formulada por una mutua no sea resuelta y notificada en el plazo de cinco días, la mutua podrá solicitar el alta al INSS o al ISM. La entidad gestora resolverá en el plazo de **cuatro días** siguientes a su recepción.

El INSS y el ISM realizarán el seguimiento del comportamiento del nuevo procedimiento de gestión y control de los procesos por IT, incluyendo el grado de motivación clínica de las pr
